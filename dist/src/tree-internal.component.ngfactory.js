...
function View_TreeInternalComponent_8(_l) { return i0.ɵvid(0, [(_l()(), i0.ɵeld(0, 0, null, null, 1, "input", [["class", "node-value"], ["id", "rename-input"], ["type", "text"]], null, [[null, "keydown"], [null, "input"], [null, "valueChanged"], [null, "keyup.enter"], [null, "blur"], [null, "keyup.esc"]], function (_v, en, $event) { var ad = true; var _co = _v.component; if (("keyup.enter" === en)) {
        ...
        var pd_4 = (_co.inputChangeHandler($event) !== false);
        ad = (pd_4 && ad);
    } if (("valueChanged" === en)) {
        var pd_5 = (_co.applyNewValue($event) !== false);
        ad = (pd_5 && ad);
