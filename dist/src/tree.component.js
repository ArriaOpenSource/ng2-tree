...
export class TreeComponent {
    static { this.EMPTY_TREE = new Tree({ value: '' }); }
    ...
    static { this.ɵfac = function TreeComponent_Factory(t) { return new (t || TreeComponent)(i0.ɵɵdirectiveInject(TreeService)); }; }
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: TreeComponent, selectors: [["tree"]], contentQueries: function TreeComponent_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TreeComponent, [{
    ...
    }], () => [{ type: i2.TreeService, decorators: [{
                type: Inject,
                args: [TreeService]
            }] }], { treeModel: [{
            type: Input,
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(TreeComponent, { className: "TreeComponent", filePath: "src\\tree.component.ts", lineNumber: 38 }); })();
